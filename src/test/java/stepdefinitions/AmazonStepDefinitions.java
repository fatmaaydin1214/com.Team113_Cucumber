...
public class AmazonStepDefinitions {
    ...
    public void saniyeBekler(int beklenecekSaniye) {
        ...
        //Cucumber sayi yazildiginda direk parametre olaek kabul eder.
    ...
    @Then("acilan urun isminin \"Nutella icerdigini test eder")
    public void acilan_urun_isminin_nutella_icerdigini_test_eder() {
    ...
    public void acilan_urun_isminin_icerdigini_test_eder(String arananKelime) {
        String actualUrunIsmi = this.amazonPage.ilkUrunIsimElementi.getText();
